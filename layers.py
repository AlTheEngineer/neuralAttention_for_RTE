...
class EmbeddedLayer(lasagne.layers.Layer):
	...
	#initialize parent layer
        ...
        #parameterize with word embeddings
        self.unchanged_W = self.add_param(unchanged_W, unchanged_W_shape, name="unchanged_W",
                                          trainable=False,
                                          regularizable=False)
...
class Decoder(lasagne.layers.LSTMLayer):
	...
	#initialize parent layer
        super(Decoder, self).__init__(incoming, num_units, ingate, forgetgate, cell, outgate, nonlinearity,
                                                cell_init, hid_init, backwards, learn_init, peepholes, gradient_steps,
